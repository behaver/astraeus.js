...
describe('#index', () => {
  describe('Verify', () => {
    it('恒星 θPersei 赤道坐标计算，参照《天文算法》', () => {
      ...
      expect(ec1.longitude.getDegrees()).to.closeTo(41.5599646, 0.005);
      expect(ec1.latitude.getDegrees()).to.closeTo(49.3520685, 0.001);
    });
    ...
    it('仙女座α星', () => {
      ...
      expect(eqc.longitude.getDegrees()).to.closeTo(311.2155, 0.2);
      expect(eqc.latitude.getDegrees()).to.closeTo(8.393648, 0.3);
    });
  })
});